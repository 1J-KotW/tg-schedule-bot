...
**PSUTI (Поволжский государственный университет телекоммуникаций и информатики)**
...
| **КСПСУТИ** | `kspsuti.raspisanie.space` | 🚧 В разработке | @kspsuti_rasp_bot |
| **ССЭУ** | `sseu.raspisanie.space` | 🚧 В разработке | @sseu_rasp_bot |
| **СамГУПС** | `samgups.raspisanie.space` | 🚧 В разработке | @samgups_rasp_bot |
...
### Рабочий пример: PSUTI
Попробуйте [@psuti_rasp_bot](https://t.me/psuti_rasp_bot?startapp=go) прямо сейчас:

1. **Telegram Mini App** — откройте бота и нажмите "Open App"
